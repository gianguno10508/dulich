...
<body>
    ...
    <div class="article-composition">
        <div class="container">
            <p style="color:#000;font-family: 'ZCOOL QingKe HuangYou', cursive; font-weight:500; font-size:60px; ">
                TRAVEL</p>
            ...
            <div id="mycarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" style="width: 100%; height:500px; min-width:1000px;"
                            src="./upload/slider_2.jpg">
                    ...
                    <div class="carousel-item">
                        <img style="width: 100%; height:500px;" class="d-block w-100" src="./upload/nhatrang.jpg">
                    </div>
                    <!--Slide 3-->
                    <div class="carousel-item">
                        <img style="width: 100%; height:500px;" class="d-block w-100" src="./upload/bn.jpg">
                    </div>
                    ...
                    <td style="width: 50%;     text-align: right;">
                        <div class="container-1">
                            <form style="margin: 0px; padding: 0px;" action="./search.php">
                                ...
                                <button type="submit" value="Tìm kiếm" class="btnsearch" style="width: 100%;">
                                </button>
                            </form>
                        </div>
                    </td>
                                     ...
                                     <tr>
                                         <td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding-left: 10px;"><b>Mã tour: </b> ' . $getdata[$count][6] . '</td>
                                             </tr>
                                             <tr>
                                                     <td><i class="fas fa-calendar-alt"></i></td>
                                                     <td style="padding-left: 10px;"><b>Ngày khởi hành: </b>' . $getdata[$count][7] . '</td>
                                                 </tr>
                                                 <tr>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td style="padding-left: 10px;"><b>Điểm khởi hành: </b>' . $getdata[$count][9] . '</td>
                                                 </tr>
                                             </table>
                                             <td style="padding-left: 50px;">
                                                 <table> 
                                                     <tr>
                                                         ...
                                                         <td style="padding-left: 10px;"><b>Điểm đến: </b> ' . $getdata[$count][10] . '</td>
                                                     </tr>
                                                     <tr>
                                                         <td> <i class="fas fa-chair"></i></td>
                                                         <td style="padding-left: 10px;"><b>Số lượng vé: </b> ' . $getdata[$count][11] . '</td>
                                                     </tr>
                                                 </table>
                                             </td>
                                         </td>
